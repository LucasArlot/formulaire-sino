...
const Timeline: React.FC<TimelineProps> = ({ currentStep, totalSteps, translations }) => {
  ...
  return (
    <div className="timeline-container">
      <div className="timeline-progress">
        {timelineItems.map((item, index) => (
          <React.Fragment key={index}>
            <div className={`timeline-item ${currentStep > index + 1 ? 'completed' : currentStep === index + 1 ? 'active' : ''}`}>
      ...
      <div className="timeline-info">
        <span className="timeline-step-count">{translations.stepCounter} {currentStep}/{totalSteps}</span>
