        ...
        {formData.mode && (
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              >
                {formData.mode === 'Sea' && t('seaFeedback', '')}
                {formData.mode === 'Rail' && t('railFeedback', '')}
                {formData.mode === 'Air' && t('airFeedback', '')}
                {formData.mode === 'Express' && t('expressFeedback', '')}
                {formData.mode === 'Unsure' && t('unsureShippingFeedback', '')}
              </span>
            </div>
          </div>
        )}
