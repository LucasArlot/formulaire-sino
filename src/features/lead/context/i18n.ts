...
const ES_TEXT: Record<string, string> = {
  ...
  personalHazardousHelp:
    'Marque si envía efectos personales o mercancías que requieren manejo especial',
  ...
  rateValidityText:
    'Las tarifas cotizadas son válidas hasta la fecha de vencimiento indicada en cada cotización. Si sus mercancías no están listas para la recogida en esa fecha, las tarifas podrían cambiar según las condiciones actuales del mercado.',
